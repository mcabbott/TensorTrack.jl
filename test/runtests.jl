using Test
using TensorTrack, TensorOperations, Tracker, Zygote, ForwardDiff
...
@testset "tracker" begin
    ...
    @test_broken gradtest(con2add, (2,3))
    ...
    @test_broken gradtest(con15, (3,3,9,9))
...
@testset "zygote" begin
    ...
    x23 = rand(2,3);
    f = ForwardDiff.gradient(x -> sum(sin, add2(x)), x23)
    ...
    xx = rand(3,3,9,9);
    f = ForwardDiff.gradient(x -> sum(sin, con16(x)), xx)
